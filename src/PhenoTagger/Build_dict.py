...
def build_dict(hpofile, outpath,rootnode):
    ...
    if rootnode[0].startswith('MS:'):
        fout_nodes.write('MS:None'+'\n') #neg label
    else:
...
if __name__=="__main__":
    ...
    parser.add_argument('--input', '-i', help="input the ontology .obo file",default='../../../ontology/mesh_addsyn.obo') # hp.obo CTD_diseases.obo chebi.obo
    parser.add_argument('--output', '-o', help="the output path of dictionary",default='../../../dict/')
    parser.add_argument('--rootnode','-r',help="input the root node of the ontogyly",nargs='+', default=['MS:D000000'])
